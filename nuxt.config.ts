...
export default defineNuxtConfig({
  ...
  modules: ['@nuxtjs/tailwindcss', '@nuxtjs/color-mode', '@vueuse/motion', '@nuxt/icon', '@nuxtjs/i18n', 'nuxt-umami', '@nuxtjs/sitemap', '@nuxtjs/robots', 'nuxt-og-image', '@nuxt/image', '@vercel/speed-insights', '@vercel/analytics'],
