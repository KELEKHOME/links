...
const { leads, fetchLeads, updateLeadStatus, deleteLead, exportToCSV } = useLeads()
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 shadow-sm">
        ...
        <div class="flex items-center gap-2 self-start sm:self-center">
          <button
            ...
            @click="handleRefresh"
            :disabled="refreshing"
            class="px-3 py-2.5 rounded-xl bg-stone-100 dark:bg-stone-800 hover:bg-stone-200 dark:hover:bg-stone-700 text-stone-800 dark:text-stone-200 text-xs font-medium transition-colors cursor-pointer flex items-center gap-1.5"
          >
            <Icon name="mdi:refresh" :class="{ 'animate-spin': refreshing }" class="text-base" />
